...
local function on_attach(bufnr)
  ...
  vim.keymap.set("n", "<C-v>", api.node.open.vertical, opts("Open: Vertical Split")) -- Same as in Telescope
  vim.keymap.set("n", "m", api.fs.rename, opts("Rename"))
  vim.keymap.set("n", "r", api.tree.reload, opts("Refresh"))
  vim.keymap.set("n", "R", api.node.run.system, opts("Run System"))
  vim.cmd([[
  :hi NvimTreeGitMergeIcon guifg=red
  :hi NvimTreeGitNewIcon guifg=gold
  ]])
end
